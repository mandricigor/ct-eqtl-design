...
use_python("/u/local/apps/python/3.7.2/bin/python3.7", required = TRUE)
...
inferred_ct <- str_replace(outputdata, "CELLTYPE", "INFERRED_CELL_TYPES")
write.table(igor@meta.data$celltype, file=inferred_ct, quote=F)
